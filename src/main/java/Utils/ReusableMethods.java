...
public class ReusableMethods
{
	public static String getTitle()
	{
		...
		{
			ReusableMethods.log("Title of the Page is not fetched, Exception seen in:" + e.getClass().getName() + " " + "Exception message is:" + e.getMessage());
		}
	...
	public static void doMouseHover(WebElement element)
	{
		try
		{
			Actions select = new Actions(DriverManager.driver);
	...
	public static List<String> fetchTextFromList(List<WebElement> elements)
	{
		...
		{
			//BasePage.log("Exception is:" + e.getMessage() + " " + "Element text is null:" + element);
			e.printStackTrace();
		}
	...
	public static void waitAndSendKeys(WebElement element, String input)
	{
		...
		try 
		{
			WebDriverWait wait = new WebDriverWait(DriverManager.driver, Duration.ofSeconds(Variables.explicitWait));
			wait.until(ExpectedConditions.visibilityOf(element)).sendKeys(input);
		}

		catch(Exception e)
		{
			ReusableMethods.log("Not able to send the key's to the element: " + element.getText() + " " + "Exeception got: " + e.getMessage());
			e.printStackTrace();
		}
	...
	public static void waitAndClick(WebElement element)
	{
		...
		{
			ReusableMethods.log("Not able to click on the element: " + element.getText() + " " + "Exeception got: " + e.getMessage());
			e.printStackTrace();
		}
	}
