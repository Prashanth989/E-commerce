...
public final class BrowserFactory {
	...
	public static void initialiseBrowser(String browserToLaunch) throws IOException {
		try {
			...
			System.out.println("Thread: " + Thread.currentThread().getId() + " " + "Valve of the thread: "
			...
			if (DriverFactory.getDriver() == null) {
				...
				default:
					throw new Exception(
							"Invalid browser parameter is given from the testng.xml - parameterisation section");
				}
			}
			...
			System.out.println("---------- Application Url: " + ReadPropertiesFile.getValve("applicationUrl")
					+ " Is launching ----------");
			DriverFactory.getDriver().get(ReadPropertiesFile.getValve("applicationUrl"));
			DriverFactory.getDriver().manage().timeouts().pageLoadTimeout(Duration.ofSeconds(Variables.pageLoadTimeOut));
	...
	public static void quitBrowser() {
		try {
			if (DriverFactory.getDriver() != null) {
				System.out.println("Driver: Thread: " + DriverFactory.getDriver() + " : "
						+ Thread.currentThread().getId() + " Is Closing");
